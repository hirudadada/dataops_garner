...
module Garner
  ...
  App.register_provider(:settings, from: :dry_system) do
    settings do
      ...
      setting :simulation_job_steps, default: 5, constructor: Types::Coercible::Integer.constrained(gteq: 1)
      ...
      setting :simulation_job_max_batches, default: Float::INFINITY, constructor: Types::Optional::Coercible::Float.constrained(gteq: 1)
      setting :simulation_job_batch_size, default: 10, constructor: Types::Coercible::Integer.constrained(gteq: 1)
      setting :simulation_job_batch_wait, default: 20, constructor: Types::Coercible::Float.constrained(gteq: 0.1)
      setting :simulation_job_iterations, default: 3, constructor: Types::Coercible::Integer.constrained(gteq: 1)
      ...
      setting :ingestion_job_max_batches, default: Float::INFINITY, constructor: Types::Optional::Coercible::Float.constrained(gteq: 1)
      ...
      setting :apm_server_url, default: '', constructor: Types::String.constrained(filled: true)
      setting :apm_secret_token, default: '', constructor: Types::String.constrained(filled: true)
    end
  end
end
